    ...
    for document in reader:
        ...
        if abstract and refSummary:
            try:
                ...
                prompt = f"You are a skilled science communicator tasked with explaining a complex biomedical paper to a lay audience. First, identify the key points: What is the study about? Who does it impact? What are the main findings? Then, create a summary that weaves these points together in a coherent and engaging way. Here is the abstract: {abstract}"
